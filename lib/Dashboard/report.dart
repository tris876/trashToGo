...
class Reportside extends StatefulWidget {
  Reportside({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ReportsideState createState() => _ReportsideState();
}

class _ReportsideState extends State<Reportside> {
